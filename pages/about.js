      ...
      <div className="font-sans bg-gray-50">
        <div className="container mx-auto px-4 py-8">
          ...
          <p className="text-xl text-center text-gray-600 mt-4">
            ...
            founder, Chef John Doe. Since then, our mission has remained
            unchanged - to deliver an unforgettable culinary experience.
          </p>
          ...
          <div className="mt-8">
            ...
            <p className="text-xl text-gray-600 mt-4">
              Our team are passionate culinary professionals who strive every
              day for perfection. Each member of the team brings something
              unique to our offer, creating a unique atmosphere in our
              restaurant.
            </p>
